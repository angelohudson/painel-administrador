...
export default function AssociateMembers(props) {
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              ...
              <p className={classes.cardCategoryWhite}>Selecione os membros para associar ao ministério</p>
            </CardHeader>
            <CardBody>
              <Table
            ...
            <CardFooter>
              <Button onClick={doAssociate} disabled={!tableCheckedIndex.length} color="primary">Associar</Button>
            </CardFooter>
          </Card>
        </GridItem>
      </GridContainer>
